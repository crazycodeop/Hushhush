...
import { Button, Element, Portion, Row, Text } from "fictoan-react";
import axios from "axios";
import { useState } from "react";
import { getRandomInt, shuffleArr } from "@/utils";

import RandomImage from "../asset/random.jpeg";
...
const hts = [
	...
	},
	{
		...
		previewURL: "https://cdn.pixabay.com/photo/2015/01/07/11/31/tigers-591359_150.jpg",
		previewWidth: 150,
		previewHeight: 96,
		webformatURL:
	...
	},
	{
		...
		previewURL: "https://cdn.pixabay.com/photo/2014/12/22/10/04/lions-577104_150.jpg",
		previewWidth: 150,
		previewHeight: 100,
		webformatURL:
	...
	{
		id: 1118467,
		pageURL: "https://pixabay.com/photos/lion-animal-head-face-mane-mammal-1118467/",
		type: "photo",
		tags: "lion, animal, head",
		previewURL: "https://cdn.pixabay.com/photo/2016/01/02/16/53/lion-1118467_150.jpg",
		previewWidth: 150,
		previewHeight: 99,
		webformatURL:
	...
	},
	{
		...
		previewURL: "https://cdn.pixabay.com/photo/2014/11/03/17/40/leopard-515509_150.jpg",
		previewWidth: 150,
		previewHeight: 99,
		webformatURL:
...
export default function Home() {
	...
	const handler = async () => {
		try {
			...
			// 	"https://pixabay.com/api/?key=34455971-5a77a994b4509efa88800b783&q=cat&image_type=photo"
			// );
			...
			// let totalImages = [];
			// for (let i = 0; i < 8; i++) {
			// 	totalImages.push(reducedImages[getRandomInt(reducedImages.length)]);
			// }
	...
	return (
		<IndexStyled>
			...
			<Row>
				<Portion>
					<Button kind="primary" onClick={handler}>
						Show
					</Button>
					<Element as="div" className="image-grid" padding="nano">
						{imageSet
						...
						onClick={async () => {
							try {
								const response = await axios.post("/api/connectDB", {
									imagesSet: imageSet,
									selectedImagesSet: selectedImages,
								});
